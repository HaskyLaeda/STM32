...
//
//    // Устанавливаем Port A Pin 9 в режим Alternate (USART1 TX) 50MHz push-pull
//  GPIOA->CRH |= (GPIO_CRH_MODE9_1 | GPIO_CRH_MODE9_0);    // MODE9 = 11
//  GPIOA->CRH |= GPIO_CRH_CNF9_1;                          // ..
//  GPIOA->CRH &= ~GPIO_CRH_CNF9_0;                         // CNF9 = 10
//  
//    // Устанавливаем Port A Pin 10 в режим Alternate (USART1 RX) 50MHz push-pull
//  GPIOA->CRH |= (GPIO_CRH_MODE10_1 | GPIO_CRH_MODE10_0);  // MODE10 = 11 
//  GPIOA->CRH |= GPIO_CRH_CNF10_1;                         // ..
//  GPIOA->CRH &= ~GPIO_CRH_CNF10_0;                        // CNF10 = 10
